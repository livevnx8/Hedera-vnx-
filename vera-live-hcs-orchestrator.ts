 ...
 * 
 * Usage: npx tsx vera-live-hcs-orchestrator.ts
 */
...
import { paymentTopicManager } from './src/vera/orchestrator/topicManager';
import { PaymentRegistryWatcher } from './src/vera/orchestrator/registryWatcher';
...
class LiveHCSLogger {
  ...
  getStats() {
    ...
    return {
      ...
      uptime: elapsed,
      messagesPerMinute: (this.messageCount / (elapsed / 60000)).toFixed(2)
    };
  }
}
