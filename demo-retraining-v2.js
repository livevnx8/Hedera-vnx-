...
/**
 * Vera Retraining Demo with HCS Logging (v2)
 * 
...
import { VeraRetrainingSystem } from './dist/retraining/retrainingSystem.v2.js';

console.log('═══════════════════════════════════════════════════════════════');
console.log('  🧠 VERA RETRAINING - WITH HCS LOGGING (v2)');
console.log('═══════════════════════════════════════════════════════════════\n');
